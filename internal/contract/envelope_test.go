...
const goldenSuccess = `{"schema_version":"1.1","capabilities":["help-json","resolve-block","dry-run","partial-success","land"],"op_id":"op_test","command":"isolate new","ok":true,"action":"created","dry_run":false,"repos":[],"warnings":[],"next":[],"error":null}`
